...
const Prac = () => (
  ...
  <footer class={styles.footer}>
    <SunnySideLogo fill="hsl(167, 40%, 24%)" />
    <ul class={styles.footer__links}>
      <li class={styles.footer_link}>About</li>
      <li class={styles.footer_link}>Services</li>
      <li class={styles.footer_link}>Projects</li>
    </ul>

    <div class={styles.footer__social}>
      <FbIcon fill="hsl(167, 40%, 24%)" />
      <IgIcon fill="hsl(167, 40%, 24%)" />
      <TwIcon fill="hsl(167, 40%, 24%)" />
      <PinIcon fill="hsl(167, 40%, 24%)" />
    </div>
  </footer>
  </>
);
